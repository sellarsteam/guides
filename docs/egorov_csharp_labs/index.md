...
Для создания класса в индивидуальном задании л.р 5 необходимо создать документацию.

### Выполнение

1. Устанавливаем doxygen
...
2. Заходим в папку с проектом и генерируем документацию

   ```bash
   doxygen -g Doxyfile
   ```

   После чего создаётся файл с конфигом, после чего мы его редактируем под себя и для подтверждения вводим следующую комманду
...
Создались папки с документацией, находим в одной из них index.html - это и есть, сгенерированные доки.
